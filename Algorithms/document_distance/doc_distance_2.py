...
# This algorithm's performance is 30% better than the first one

# Changes from the first version:
# - concatenation of the arrays changed into the method extend()
...
class Document():
    ...
    def extractWords(self, lines):
        ...
        for l in lines:
            ...
            self.wordlist.extend(words) # THE ONLY CHANGE IN THE DOCUMENT
...
def main():
    if (len(sys.argv) != 3):
        print "Usage: python doc_distance_2.py textfile1 textfile2"
    else:
