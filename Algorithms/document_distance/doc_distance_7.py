...
# - Removed sorting whatsoever
# - Updated method for frequency counting to leave the result as dictionary
# - Dot product function updated to adapt to changes
...
def main():
    if (len(sys.argv) != 3):
        print "Usage: python doc_distance_7.py textfile1 textfile2"
    else:
